...
/**
 * Inset var events for every variable declaration or assingment
 * @author rlindeman
 *
 */
public class VarStatementsTests extends EventInstrumentationBase {
	...
	public void setup()
	{
		...
		loadDSLDI(ALTestConstants.ALNG_SCRIPTS_DIR + "/dsldis/VarStatements.dsldi");
	...
	public void instrumentJustPrint()
	{
		...
		compareDslProgramSourceWithAlng(this.getInstrumentedLocation(".var.alng"));
	}
	...
	@Test
	public void instrumentAssigninblock()
	{
		sourceDSLLocation = ALTestConstants.ALNG_SCRIPTS_DIR + "/testcases/statements/assigninblock.alng";
		cleanupGenerated();
