...
public class GlobalFunctionDeclVoidNoArgs extends ParsedProgramBase {

	@Override
	public void init() {
		String alng_program_location = ALTestConstants.ALNG_SCRIPTS_DIR + "/testcases/fargs/noargs.alng";
