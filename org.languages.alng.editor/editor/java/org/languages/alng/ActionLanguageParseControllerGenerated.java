...
public class ActionLanguageParseControllerGenerated extends DynamicParseController 
{ 
  public static final String LANGUAGE = new String("ActionLanguage");
  ...
  { 
    ActionLanguageParseControllerGenerated.descriptor = descriptor;
  }
  ...
  { 
    try
    { 
      InputStream descriptorStream = ActionLanguageParseControllerGenerated.class.getResourceAsStream(DESCRIPTOR);
      InputStream table = ActionLanguageParseControllerGenerated.class.getResourceAsStream(TABLE);
      ...
      descriptor.setAttachmentProvider(ActionLanguageParseControllerGenerated.class);
    }
  ...
  { 
    return ActionLanguageParseController.class.getProtectionDomain().getCodeSource().getLocation().getFile();
  }
